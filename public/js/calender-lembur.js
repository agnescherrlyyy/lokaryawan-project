document.addEventListener("DOMContentLoaded", function () {
    ...
    calendar.addEventListener("click", function (event) {
        if (
            ...
            const encryptedDateLembur = CryptoJS.AES.encrypt(JSON.stringify(formattedDate), 'base64:3nMewpgVZ67OrYpN+7In1VnRAk8N99/s8yVvgCw9eCQ=').toString();
            localStorage.setItem('encryptedDateLembur', encryptedDateLembur);
    ...
    const encryptedDateLembur = CryptoJS.AES.encrypt(
