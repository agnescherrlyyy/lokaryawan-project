            ...
            <div class="w-full lg:w-1/2">
                <div class="w-full relative select-box">
                    <div class="show-menu w-full flex items-center justify-between gap-4 border-2 border-sekunder-40 px-4 py-3 rounded-lg cursor-pointer bg-white dark:bg-slate-700">
                        <input class="w-full text-box border-none focus:ring-0 active:ring-0 p-0 focus:outline-none active:outline-none text-sm placeholder:text-slate-950 dark:placeholder:text-slate-50 bg-transparent font-medium cursor-pointer" type="text" name="" placeholder="Pilih Periode Absenku" id="so-value" readonly>
