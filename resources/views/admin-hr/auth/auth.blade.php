...
<head>
    ...
    <title>Admin Login &mdash; LOKARYAWAN</title>
    @vite('resources/css/app.css')
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
</head>
<body class="font-Poppins">
    <section id="bg-login" class="max-w-full w-full min-h-screen h-full flex flex-col items-center justify-center px-5 lg:px-16">
        ...
        <div class="w-full flex items-center justify-center z-50">
            <div class="max-w-sm w-full bg-gray-50 lg:bg-white px-2 lg:px-6 lg:py-6 rounded-lg overflow-hidden lg:shadow-sm">
                <span class="block font-semibold text-primer-60 text-xl">Login Admin LOKARYAWAN</span>
                    ...
                    <form action="" method="POST">
                        <div class="w-full mb-4 relative">
                            ...
                            <input 
                                ...
                                id="username"
                                name="username"
                                class="w-full text-sm border rounded-md py-3 pl-10 pr-4 text-slate-700 focus:outline-none  focus:border-sekunder-60 focus:ring-2 focus:ring-sekunder-40 placeholder:opacity-50 transition-all duration-200 ease-in-out bg-gray-50 lg:bg-white"
