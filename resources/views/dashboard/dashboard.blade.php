...
@section('content')
    <!-- Heading Start -->
    <div
        class="max-w-full w-full px-10 lg:pl-10 lg:pr-10 lg:flex lg:items-start lg:justify-between py-4 bg-white dark:bg-slate-800">
        <div class="w-full">
    ...
    <section class="block mt-9 px-5 lg:pl-10 lg:pr-10">
        <div class="w-full grid grid-cols-1 gap-x-4 gap-y-5 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            <div class="w-full flex gap-5 px-6 py-4 bg-white dark:bg-slate-800 rounded-lg">
                <div class="w-10 h-10">
                    <img src="{{ asset('img/absen-terakhir-svg.svg') }}" alt="icon" class="w-full h-full">
                </div>
            ...
            <div class="w-full flex gap-5 px-6 py-4 bg-white dark:bg-slate-800 rounded-lg">
                <div class="w-10 h-10">
                    <img src="{{ asset('img/absen-selanjutnya-svg.svg') }}" alt="icon" class="w-full h-full">
                </div>
                <div class="flex flex-col gap-2">
                    <span class="tanggal font-medium text-sm"></span>
            ...
            <div class="w-full flex gap-5 px-6 py-4 bg-white dark:bg-slate-800 rounded-lg">
                <div class="w-10 h-10">
                    <img src="{{ asset('img/terlambat-svg.svg') }}" alt="icon" class="w-full h-full">
                </div>
                <div class="flex flex-col gap-2">
                    <span class="tanggal font-medium text-sm"></span>
            ...
            <div class="w-full flex gap-5 px-6 py-4 bg-white dark:bg-slate-800 rounded-lg">
                <div class="w-10 h-10">
                    <img src="{{ asset('img/kedatangan-komplimen-tiket-svg.svg') }}" alt="icon" class="w-full h-full">
                </div>
                <div class="flex flex-col gap-2">
        ...
        <div class="w-full grid grid-cols-2 md:grid-cols-3 gap-y-6 px-2 py-4 mt-6 bg-white dark:bg-slate-800 rounded-lg">
            <div
                class="w-full flex flex-col md:flex-row md:gap-5 md:items-center gap-3 px-4 md:py-4 border-r border-r-slate-100 dark:border-r-slate-700 bg-white dark:bg-slate-800">
                <div class="w-8 h-8 md:w-12 md:h-12">
                    <img src="{{ asset('img/sisa-komplemen-100-svg.svg') }}" alt="icon" class="w-full h-full">
                </div>
            ...
            <div
                class="w-full flex flex-col md:flex-row md:items-center md:gap-5 gap-3 px-4 md:py-4 bg-white dark:bg-slate-800 md:border-r md:border-r-slate-100 dark:md:border-r-slate-700">
                <div class="w-8 h-8 md:w-12 md:h-12">
                    <img src="{{ asset('img/sisa-komplemen-50-svg.svg') }}" alt="icon" class="w-full h-full">
                </div>
                <div class="flex flex-col gap-1">
            ...
            <div
                class="w-full flex flex-col md:flex-row md:gap-5 md:items-center gap-3 px-4 md:py-4 bg-white dark:bg-slate-800 border-r border-r-slate-100 dark:border-r-slate-700 xl:border-0">
                <div class="w-8 h-8 md:w-12 md:h-12">
                    <img src="{{ asset('img/cuti-svg.svg') }}" alt="icon" class="w-full h-full">
                </div>
                <div class="flex flex-col gap-2">
            ...
            <div
                class="w-full flex flex-col md:flex-row md:gap-5 md:items-center gap-3 px-4 md:py-4 bg-white dark:bg-slate-800">
                <div class="w-8 h-8 md:w-12 md:h-12">
                    <img src="{{ asset('img/cuti-svg.svg') }}" alt="icon" class="w-full h-full">
                </div>
                <div class="flex flex-col gap-2">
        ...
        <div class="w-full mt-9">
            <div class="w-full flex items-center justify-between">
                ...
                <button
                    class="lihat-semua hidden w-fit lg:flex lg:items-center lg:gap-2 font-medium text-xs text-primer-60 group hover:bg-primer-20 px-4 py-2 rounded-full">
                    Lihat semua
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 mt-4">
                <div class="w-full overflow-hidden">
                    <img src="{{ asset('img/1696126594PromomelaluiWebSaloka.jpg') }}" alt="" class="rounded-md">
                    <div class="flex flex-col gap-4 py-4">
                        ...
                        <a href="#"
                            class="infos w-fit flex items-center gap-2 pb-1 border-b border-b-primer-60 text-primer-60 hover:text-primer-40">
                ...
                <div class="w-full overflow-hidden">
                    <img src="{{ asset('img/Hospitality_page-0001.jpg') }}" alt=""
                        class="w-full h-[154px] object-cover object-top rounded-md" </div>
                    <div class="flex flex-col gap-4 py-4">
                        <div class="flex flex-col gap-1">
                        ...
                        <a href="#"
                            class="hosfitality w-fit flex items-center gap-2 pb-1 border-b border-b-primer-60 text-primer-60 hover:text-primer-40">
                            <span class="font-semibold text-xs uppercase">Baca lebih lanjut</span>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                class="w-4 h-4">
                                <path fill-rule="evenodd"
                ...
                <div class="w-full overflow-hidden">
                    ...
                    <div class="flex flex-col gap-4 py-4">
                        ...
                        <a href="#"
                            class="mb-komplemen w-fit flex items-center gap-2 pb-1 border-b border-b-primer-60 text-primer-60 hover:text-primer-40">
                            <span class="font-semibold text-xs uppercase">Baca lebih lanjut</span>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                class="w-4 h-4">
                                <path fill-rule="evenodd"
                ...
                <div class="w-full overflow-hidden">
                    <img src="{{ asset('img/financeandnon/MATERI FINANCE & ACCOUNTING FOR NON ACCOUNTANT_BY PAK RIDWAN (PRINT)_page-0001.jpg') }}"
                        alt="" class="rounded-md">
                    <div class="flex flex-col gap-4 py-4">
                        <div class="flex flex-col gap-1">
                            <span class="text-sm text-slate-500">04 Maret 2024</span>
                            <h1 class="font-semibold text-lg">Finance & Accounting
                                for Non Accountant</h1>
                        </div>
                        <a href="#"
                            class="btn-finance w-fit flex items-center gap-2 pb-1 border-b border-b-primer-60 text-primer-60 hover:text-primer-40">
                            <span class="font-semibold text-xs uppercase">Baca lebih lanjut</span>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                class="w-4 h-4">
                                <path fill-rule="evenodd"
                ...
                <div class="w-full overflow-hidden">
                    ...
                    <div class="flex flex-col gap-4 py-4">
                        <div class="flex flex-col gap-1">
                            <span class="text-sm text-slate-500">21 Maret 2024</span>
                            <h1 class="font-semibold text-lg">Standar Layanan Prima Saloka Theme Park</h1>
                        </div>
                        <a href="#"
                            class="btn-layanan-prima w-fit flex items-center gap-2 pb-1 border-b border-b-primer-60 text-primer-60 hover:text-primer-40">
                            <span class="font-semibold text-xs uppercase">Baca lebih lanjut</span>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                class="w-4 h-4">
                                <path fill-rule="evenodd"
            ...
            <div class="w-full flex items-center justify-center mt-6 lg:hidden">
                <a href="#"
                    class="lihat-semua px-4 py-3 rounded-full border border-sekunder-60 text-sekunder-60 hover:border-sekunder-60 hover:bg-sekunder-60 hover:text-slate-50 font-medium text-sm w-fit">
                    Lihat semua
                </a>
            </div>
        </div>
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.status === 'success') {
                            ...
                            var tanggalAkhir = tanggalNormal.getDate() + " " + getNamaBulan(
                                tanggalNormal.getMonth()) + " " + tanggalNormal.getFullYear();
            ...
            $('.btn-finance').click(function(e) {
                e.preventDefault();
                window.location.href = "{{ url('/finance-non') }}";
            });

            $('.btn-layanan-prima').click(function(e) {
                e.preventDefault();
                window.location.href = "{{ url('/seputar-info/standar-layanan-prima') }}";
            });
        ...
        $.ajax({
            ...
            type: "GET",
            success: function(response) {
                if (response.data === "Data Request Komplemen Karyawan Tidak Ditemukan" || response.data ===
                    null) {
