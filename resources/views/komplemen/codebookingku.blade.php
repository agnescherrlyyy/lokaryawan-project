                            ...
                            success: function(response) {
                                if(response.status === 'success'){
                                    ...
                                    if (response.data === "Data Request Komplemen Karyawan Tidak Ditemukan" || response.data === null){
                                        typeKomplemen = '-';
                                    } else if (response.data !== "Data Request Komplemen Karyawan Tidak Ditemukan" || response.data !== null){
                                        typeKomplemen = JSON.parse(dataKomplemen.ticket_order);
                                        if (typeKomplemen.length === 1){
                                            textTypeKomplemen = typeKomplemen[0].product_name;
                                        } else if (typeKomplemen.length === 2){
                                            textTypeKomplemen = typeKomplemen[0].product_name + ' & ' + typeKomplemen[1].product_name;
                                        }
                                    }
                                    ...
                                    $('#tgl-kedatangan').text(getTanggalRange(dataKomplemen.tanggal_kedatangan));
