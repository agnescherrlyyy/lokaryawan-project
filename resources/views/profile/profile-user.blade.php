...
<head>
    ...
    <title>Profile &mdash; LOKARYAWAN</title>
...
<body class="font-Poppins bg-white">
    <section class="max-w-full w-full">
        ...
        <div class="max-w-7xl w-full mx-auto flex justify-center pt-2">
            <div class="w-full lg:max-w-lg lg:w-full p-4">
                <div class="w-full flex items-center justify-between gap-3">
                    ...
                    <span class="font-semibold">Profile User</span>
                ...
                <div class="w-full flex flex-col items-center justify-center gap-2 mt-4 ">
                    <div class="max-w-sm w-full flex flex-col it justify-center mb-4 px-4 py-4 bg-white">
                        <span class="font-semibold text-sm mb-2 text-slate-500">Setting Profile</span>
                        <div class="w-full flex items-center justify-center">
                            <button id="ganti-password" class="btn-modal w-full px-4 py-4 font-medium text-xs  flex items-center justify-between gap-2 rounded-lg bg-blue-50 hover:bg-blue-100">
            ...
            <div id="ganti-password" class="show-modal w-full max-w-full md:max-w-lg rounded-lg bg-white dark:bg-slate-700 p-4">
                ...
                <div class="w-full pt-6">
                    <form id="form_add" class="w-full flex flex-col items-center justify-center gap-4">
                        ...
                        <div class="w-full flex flex-col justify-center items-start gap-2 px-4">
                            <label for="password-baru" class="block font-semibold text-xs">Password lama</label>
                            <div class="w-full">
