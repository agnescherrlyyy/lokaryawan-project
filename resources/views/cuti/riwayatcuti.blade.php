...
@section('content')
    ...
    <div class="max-w-full w-full px-5 lg:pl-10 lg:pr-16 lg:flex lg:items-start lg:justify-between py-4 bg-white dark:bg-slate-800">
        <div class="w-full">
            ...
            <h4 class="font-medium text-slate-600 dark:text-slate-400">Riwayat Cuti Tahunan</h4>
        </div>
    </div>
    <!-- Heading End --> 
    ...
    <section class="block mt-9 px-5 lg:pl-10 lg:pr-16">
        ...
        <div class="w-full">
            <div class="w-full bg-white dark:bg-slate-800 rounded-lg mt-9">
                ...
                <div class="w-full flex flex-col gap-2 p-4 bg-white dark:bg-slate-800 rounded-b-2xl">
                    <div class="p-4 rounded-lg ">
                        <div class="flex">
                            ...
                            <div class="w-full flex flex-col gap-2">
                                <span class="block font-semibold text-sm">Request Cuti 12/10/2023</span>
                                <div class="w-full flex items-center gap-1">
                                ...
                                <span class="block text-xs text-emerald-500">12/10/23</span>
                    ...
                    <div class="p-4 rounded-lg ">
                        <div class="flex">
                            ...
                            <div class="w-full flex flex-col gap-2">
                                <span class="block font-semibold text-sm">Request Cuti 12/09/2023</span>
                                <div class="w-full flex items-center gap-1">
                                ...
                                <span class="block text-xs text-emerald-500">12/10/23</span>
                                <span class="block text-xs text-gray-500 dark:text-gray-400">07/09/23 12:54</span>
                            </div>
                        </div>
                    </div>
                </div>
