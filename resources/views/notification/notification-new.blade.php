    ...
    <section class="block mt-9 px-5 lg:pl-10 lg:pr-10">
        ...
        <div class="w-full">
            <div class="w-full bg-white dark:bg-slate-800 rounded-lg mt-9">
                <div
                    class="w-full flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3 px-4 py-6 border-b border-slate-200 dark:border-slate-700">
                ...
                <div class="w-full flex flex-col gap-4 py-4 px-4 xl:px-6">
                    ...
                    <div id="container-notification"
                        class="w-full grid grid-cols-1 md:grid-cols-2 gap-4 bg-white dark:bg-slate-800 rounded-b-2xl">
                    </div>
                </div>
                <div class="w-full flex flex-col gap-4 py-4 px-4 xl:px-6">
                    <span class="inline-block font-semibold text-sm">Notification Lembur</span>
                    <div id="container-lembur"
                        class="w-full grid grid-cols-1 md:grid-cols-2 gap-4 bg-white dark:bg-slate-800 rounded-b-2xl">
                    </div>
                </div>
            </div>
                    ...
                    if (response.status === 'success') {
                        ...
                        if (Array.isArray(dataCuti)) {
                            dataCuti.forEach(function(cutiData) {
                                ...
                                button.className =
                                    'approved-cuti w-full flex flex-col gap-2 px-4 py-3 rounded-lg border border-slate-100 dark:border-slate-600 hover:bg-slate-100 dark:hover:bg-slate-700';
                        ...
                        if (Array.isArray(dataLembur)) {
                            dataLembur.forEach(function(lemburData) {
                                ...
                                button.className =
                                    'approved-lembur w-full flex flex-row gap-4 px-4 py-3 rounded-lg border border-slate-100 dark:border-slate-600 hover:bg-slate-100 dark:hover:bg-slate-700';
