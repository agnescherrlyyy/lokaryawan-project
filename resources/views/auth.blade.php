    ...
    <section id="bg-auth" class="max-w-full w-full min-h-screen h-full flex flex-col items-center justify-center px-5 lg:px-16">
        ...
        <div class="w-full flex items-center justify-center z-50">
            <div class="max-w-sm w-full bg-white px-2 lg:px-6 lg:py-6 rounded-lg overflow-hidden lg:shadow-lg">
                ...
                <p class="text-sm text-slate-400 mt-2">Sugeng Rawuh, silahkan berikan informasi akses untuk aplikasi 👋</p>
                <div class="w-full mt-4">
                    <form action="" method="POST">
                        ...
                        <button id="btn-login" type="submit" class="text-center px-4 py-3 w-full rounded-md font-semibold text-sm text-white mt-6 bg-gradient-to-r from-sekunder-60 to-primer-60 hover:bg-gradient-to-r hover:from-primer-40 hover:to-sekunder-40 transition-all duration-200 ease-in-out">Login</button>
                    </form>
                </div>
            </div>
        </div>
